...
class sta_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'sta_widget', // Base ID
            'sta_widget', // Name
            array( 'description' => __( 'sta_widget', 'text_domain' ), ) // Args
        );
    }
...
add_action( 'widgets_init', 'sta_widget_areas' );

if ( ! function_exists( 'sta_widget_areas' ) ) {

	/** Initializes themes widgets.*/
	function sta_widget_areas() {
		register_sidebar(
			array(
				'name'          => __( 'Footer one', 'further-ed' ),
				'id'            => 'footer-col-one',
				'description'   => __( 'Footer column one widget area', 'further-ed' ),
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer two', 'further-ed' ),
				'id'            => 'footer-col-two',
				'description'   => __( 'Footer column two widget area', 'further-ed' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
        ...
        register_sidebar(
			array(
				'name'          => __( 'Footer three', 'further-ed' ),
				'id'            => 'footer-col-three',
				'description'   => __( 'Footer column three widget area', 'further-ed' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
