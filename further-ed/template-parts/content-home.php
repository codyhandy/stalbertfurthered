...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
    ...
    <section class="featured news">
        <div class="text-container max-width">
            ...
            <div class="lg-flex">
                <div class="image-container mobile-hidden max-width">
                    <img src="<?php if ($imageFeatured) {  _e($imageFeatured); } ?>" alt="">
                </div>
            <?php endif; ?>
            ...
            <div class="text-container">
                ...
                <p><?php $textFeatured2 = get_field('text-featured-2'); ?> <?php if ($textFeatured2) { _e($textFeatured2); } ?></p>
    ...
    <section class="featured about">
        <div class="text-container max-width">
            <h2><?php $headingAbout = get_field('heading-about'); ?> <?php if ($headingAbout) { _e($headingAbout); } ?></h2>
            <p><?php $textAbout = get_field('text-about'); ?> <?php if ($textAbout) { _e($textAbout); } ?></p>
